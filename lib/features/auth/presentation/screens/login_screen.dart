                  ...
                  Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        _FeaturePill(Icons.point_of_sale_rounded, 'POS & Billing'),
                        const SizedBox(height: 12),
                        _FeaturePill(Icons.kitchen_rounded, 'Kitchen Display System'),
                        const SizedBox(height: 12),
                        _FeaturePill(Icons.inventory_2_rounded, 'Inventory & Bar'),
                        const SizedBox(height: 12),
                        _FeaturePill(Icons.analytics_rounded, 'Reports & Analytics'),
